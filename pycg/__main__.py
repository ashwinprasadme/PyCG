...
from pycg.utils.constants import CALL_GRAPH_OP, KEY_ERR_OP, META_CALL_GRAPH_OP
...
def main():
    ...
    parser.add_argument("--meta", help="Produce Call Graph with Meta Information", default=False)
    ...
    parser.add_argument(
        "--operation",
        type=str,
        choices=[CALL_GRAPH_OP, KEY_ERR_OP , META_CALL_GRAPH_OP],
        help=(
    ...
    elif args.operation == META_CALL_GRAPH_OP:
